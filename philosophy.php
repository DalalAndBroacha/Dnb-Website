	...
	<div id="content" style="padding-bottom:10px">
		<div class="left">
			<ul>
				...
				<li style="border:0; padding:30px 0 0px 15px;"><a href="Dalal & Brocha Corporate Profile.pdf" target="_blank"><img src="images/profile_pdf_.gif" alt="" style="vertical-align:bottom; margin-top:10px" /><img src="images/txt_corporate_profile.gif" style="vertical-align:top; margin:13px 0 0 6px;" alt="corporate profile" /></a></li>
			</ul>
		</div> 
		<div class="right">
