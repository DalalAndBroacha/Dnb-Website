	...
	<div id="content" class="contact">
		<div class="left">
			...
			<div style="font-family:Arial; font-size:12px; padding-left:13px; float:left; width:250px; padding-right:5px; line-height:16px;">
				...
				<span style="font-weight:bold"><a href="mailto:compliance.officer@dalal-broacha.com">compliance.officer@dalal-broacha.com</a></span><br />
				
				<p><br><strong>Compliance Officer Details:</strong><br>Chetan Mehta<br>+91 (22) 2282 2992 Ext. 168<br />
				<strong>Board Line no:</strong> +91 (022) 67141414
				<br><a href="mailto:chetan.mehta@dalal–broacha.com" style="font-weight:bold">chetan.mehta@dalal–broacha.com</a></p>
			</div>
		</div>
		<div class="right">
			<div>
		...
		<option value="contact.php?city=Anand" <?php sticky_menu("Anand", $city); ?>>Anand</option>
                <option value="contact.php?city=Bangalore" <?php sticky_menu("Bangalore", $city); ?>>Bangalore</option>
